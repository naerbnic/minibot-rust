...
//! involve itself with capability negotiation or reply-response pairs, and should be handled at
//! a higher layer.
...
pub fn from_channel<
    C: futures::io::AsyncRead + futures::io::AsyncWrite + Unpin + Send + 'static,
>(
    channel: C,
) -> (IrcStream, IrcSink) {
